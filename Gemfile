...
gem 'go-cda-tools', git: 'https://github.com/projectcypress/go-cda-tools.git', branch: 'migrateToClassMethod', require: false
# gem 'go-cda-tools', path: '../go-cda-tools', require: false
